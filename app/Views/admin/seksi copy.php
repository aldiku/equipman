                                    ...
                                    <div class="card-body" style="height: 500px; overflow: scroll">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12 col-sm-3">
                                                <label for="field<?= $f['id'] ?>"><?= $f['label'] ?> <?= (strtolower($f['type']) == 'num' && !empty($f['satuan']))? '('.$f['satuan'].')' :'' ?> </label>
                                            </div>
                                            <div class="col-12 col-sm">
                                                <?php if($f['type'] == 'text'){ ?>
                                                <input id="field<?= $f['id'] ?>" type="text" value="<?= $f['value']['val'] ?>" name="<?= $f['id'] ?>" class="form-control form-control-sm" placeholder="<?= $f['label']?>" data-type="<?= $f['type']?>">

                                                <?php }elseif(strtolower($f['type']) == 'num'){ ?>
                                                <input id="field<?= $f['id'] ?>" type="number" value="<?= $f['value']['val'] ?>" name="<?= $f['id'] ?>" class="form-control form-control-sm" step="any" data-type="<?= $f['type']?>">

                                                <?php }elseif(strtolower($f['type']) == 'date'){ ?>
                                                <input id="field<?= $f['id'] ?>" name="<?= $f['id'] ?>"
                                                    type="date" class="form-control form-control-sm" value="<?= $f['value']['val'] ?>" data-type="<?= $f['type']?>">
                                                ...
                                                <select name="<?= $f['id'] ?>"
                                                    ...
                                                    <option value="<?= $op['value'] ?>" <?= ($op['value'] == $f['value']['val']) ? "selected='selected'" : '' ?>>[<?= $op['value'] ?>]<?= $op['comment'] ?></option>
                                                    <?php } ?>
                                                </select>
                                                <?php }elseif(strtolower($f['type']) == 'yesno' || strtolower($f['type']) == 'checked'){ ?>
                                                <div
                                                    class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                    <input type="checkbox" name="<?= $f['id'] ?>" <?= ($f['value']['val'] =='on') ?'checked' :'' ?> 
